...
@section('content')
    ...
    @if(($pedido->status == 'Editora' and Auth::user()->can('editora')) or ($pedido->status == 'Gráfica' and Auth::user()->can('grafica')) or (($pedido->status == 'Editora' or $pedido->status == 'Gráfica') and Auth::user()->id == $pedido->user_id))
