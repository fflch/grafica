                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="col-auto float-right">
                                    <p class="bg-light rounded" style="margin:0; padding:0;text-align:right"> {{$chat->message}}</p>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="col-auto float-left">
                                    <p class="bg-info rounded" style="margin:0; padding:0; color:#fff; text-align:left">{{$chat->message}} </p>
                                    <p style="margin:0; padding:0; color:#696969; font-size:10px">{{$chat->user->name}} - {{ Carbon\Carbon::parse($chat->created_at)->format('d/m/Y H:i:s') }}</p>
                                </div>
                            </div>
                        </div>
