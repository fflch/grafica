        ...
        <div class="col-sm">
            <form method="POST" action="/pedidos/enviar_autorizacao/{{ $pedido->id }}">
                ...
                <div class="row form-group">
                    <div class="col-sm form-check">
                        <input style="margin-left:8px" type="checkbox" name="termo_responsavel_centro_despesa" class="form-check-input" id="termo_responsavel_centro_despesa" @if($pedido->termo_responsavel_centro_despesa == 1) checked @endif>
                        <label style="margin-left:24px" class="form-check-label" for="termo_responsavel_centro_despesa">Declaro ciência na autorização e de que foi consultado anteriormente o setor da Contabilidade para tal ação.</label>
                    </div>
                </div>
                <div clas="row">
                    <div class="col-auto float-left">
